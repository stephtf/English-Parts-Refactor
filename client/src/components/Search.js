const Search = () => {
    ...
    <div className="utility-bar-top">
        <div className="container utility-bar-container">
            ...
            <div id="MyGarage" className="utility-bar__section utility-bar__select-vehicle"><div id="selectVehicle" className="utility-bar__element"><div id="selectVehicleText" title="My Garage" className="utility-bar__select-vehicle-text"></div>
            Select Your Vehicle
                    </div> <button type="button" id="UtilityBarToggleButton" title="Select Vehicle Button" aria-label="Select Vehicle Button" className="utility-bar__select-vehicle-button"><span className="icon-arrow-down select-vehicle-icon"></span></button></div> 
                    {/* <div className="boxTriangle" style="display: none;"> */}
                        ...
                        {/* <div className="garage__container" style="display: none;"> */}
                            <div id="garageContainer" className="garage garage-vehicles"><div className="garage__header">
         My Garage
         <button type="button" aria-label="close" className="close my-garage__close"><span aria-hidden="true"></span></button></div> <div className="garage__content no-garage-content">
             
             {/* <div className="garage__selection" style="display: none;"> */}
             
             <span aria-hidden="true" className="icon-partman"></span> <div className="garage__help">
               You can edit the name of your vehicle by clicking the pencil icon on the right.
            </div> <div className="garage-vehicles"></div> <div className="garage__additions no-vehicles"><div className="vehicle-selection-addition"><button type="button" className="garage__select-vehicle">
                  + Add New Vehicle
