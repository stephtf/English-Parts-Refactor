const Header = () => {
  return (
    <div>
      <a href="#top" tabindex="0" class="skip" target="_self">
        Skip to Content
      </a>
      ...
      <div id="ContentPlaceHolderContainer" className="content en"></div>
          ...
          <nav className="navbar navbar-default headerNav">
            <div className="container">
              ...
              <div className="navbar-header header-logo">
                <a className="navbar-brand business-logo" href="#top">
              ...
              <div className="navbar-text business-information">
                ...
                <div className="business-contact-details">
                  ...
                  <div className="contact-detail business-contact-details__email">
                    <a tabindex="0" className="small" href="#top">
              ...
              <button
                type="button"
                class="navbar-toggle collapsed header-mobile-toggle"
              ...
              <ul
                class="nav navbar-nav navbar-right navigation-link-group"
                id="HeaderNavigationLinks"
              >
                <li id="PartsDropdown" class="dropdown navigation-list-item">
                  <a
                    href="#top"
                    ...
                    aria-haspopup="true"
                    aria-expanded="false"
                    class="dropdown-toggle navigation-link category-links-button"
                  >
                    Parts
                  </a>{" "}
                  <ul class="dropdown-menu navlink-dropdown-menu"> </ul>
                </li>

                <li>
                  <a
                    href="#top"
                    class="about-us-link navigation-links heading-4"
                  >
                    About Us
                  </a>
                </li>
